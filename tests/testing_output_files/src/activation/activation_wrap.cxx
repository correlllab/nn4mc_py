...
#define SWIGTYPE_p_input swig_types[2]
...
/*-----------------------------------------------
              @(target):= _activation.so
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__activation

#else
#  define SWIG_init    init_activation

#endif
#define SWIG_name    "_activation"
